...
/// </summary>
[CustomEditor(typeof(ControlDisplayDropdown))]
public class ControlDisplayDropdownEditor : UnityEditor.Editor
{
       ...
       // GUILayout.Label("This is a Label in a Custom Editor");
        ...
        EditorGUILayout.LabelField(m_BindingLabel, Styles.boldLabel);
         using (new EditorGUI.IndentLevelScope())
           {
        //EditorGUILayout.PropertyField(ControlDisplayLocal);
